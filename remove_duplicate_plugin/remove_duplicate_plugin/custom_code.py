#!/usr/bin/env python
""" MultiQC remove_duplicate plugin functions
...
config.remove_duplicate_plugin_version = get_distribution("multiqc_remove_duplicate_plugin").version


# Add default config options for the things that are used in MultiQC_NGI
def remove_duplicate_plugin_execution_start():
    ...
    log.info("Running remove_duplicate MultiQC Plugin v{}".format(config.remove_duplicate_plugin_version))
