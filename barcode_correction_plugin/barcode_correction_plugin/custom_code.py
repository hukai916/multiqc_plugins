#!/usr/bin/env python
""" MultiQC barcode_correction plugin functions
...
config.barcode_correction_plugin_version = get_distribution("multiqc_barcode_correction_plugin").version


# Add default config options for the things that are used in MultiQC_NGI
def barcode_correction_plugin_execution_start():
    ...
    log.info("Running barcode_correction MultiQC Plugin v{}".format(config.barcode_correction_plugin_version))
